...
import 'package:admin_panel_ak/features/appoint/Appoint%20List/user_info_sidebar/widget/infor.dart';
import 'package:admin_panel_ak/features/appoint/Appoint%20List/user_info_sidebar/widget/infor_text_timedate.dart';
import 'package:admin_panel_ak/features/appoint/Appoint%20List/user_info_sidebar/widget/row_of_state.dart';
import 'package:admin_panel_ak/features/appoint/Appoint%20List/user_info_sidebar/widget/service_tap_orderlist.dart';
...
import 'package:admin_panel_ak/widget/button/custom_icon_button.dart';
                ...
                : showDeleteAlertDialog(context, "Cancel Appointment",
                    ...
                    try {
                      ...
                      bookingProvider.updateAppointment(
                          widget.index, widget.appointModel.id, orderUpdate);
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    Text(
                      widget.appointModel.subtotal.toString(),
                      style: TextStyle(
                        color: Colors.black,
                        fontSize: Dimensions.dimenisonNo14,
                        fontWeight: FontWeight.w600,
...
// Extra Discount
                ...
                //     const Spacer(),
                //     Text(
                //       "₹${widget.appointModel.net.toStringAsFixed(2)}",
                //       style: TextStyle(
                //         fontSize: Dimensions.dimenisonNo14,
                //         fontWeight: FontWeight.w500,
                //         letterSpacing: 0.90,
