...
class MobileBannerPage extends StatefulWidget {
  const MobileBannerPage({super.key});
  // static const String routeName = '/MobileBannerPage';

  @override
  State<MobileBannerPage> createState() => _MobileBannerPageState();
}

class _MobileBannerPageState extends State<MobileBannerPage> {
          ...
          child: Column(
            ...
            children: [
                        ...
                        Container(
                          ...
                          child: Center(
                            child: selectedImage != null
                                ...
                                : const Text('Mobile Banner Images'),
                          ),
                        ),
              ...
              StreamBuilder<List<ImageModel>>(
                stream:
                    FirebaseFirestoreHelper.instance.getMobileBannerImages(),
